...
#parallax background
$vega_wp_defaults['vega_wp_parallax_bg'] = esc_url( get_template_directory_uri() ) . '/sample/images/cta-parallax-bg.png';
...
#parallax background
$vega_wp_defaults['vega_wp_parallax_bg2'] = esc_url( get_template_directory_uri() ) . '/sample/images/cta-parallax-bg2.png';
