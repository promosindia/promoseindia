...
<head>
<meta charset="utf-8">
<title>InLine Hosting business Free HTML5 Template</title>
...
<?php get_template_part('include/slider'); ?>  
    ...
    <div class="container">
        ...
        <span class="icons c1"><i class="icon-layers"></i></span> <div class="box-area">
        <h3>Web Hosting</h3> <p>Lorem ipsum dolor sitamet, consec tetur adipisicing elit. Dolores quae porro consequatur aliquam, incidunt eius magni provident</p></div></div>
        </div>
        <div class="col-md-4 text-center"> 
        <div class="box-content focus"> 
        <span class="icons c2"><i class="icon-gears"></i></span> <div class="box-area">
        <h3>Cloud Service</h3> <p>Lorem ipsum dolor sitamet, consec tetur adipisicing elit. Dolores quae porro consequatur aliquam, incidunt eius magni provident</p></div></div>
        </div>
        <div class="col-md-4 text-center">  
        <div class="box-content">
        <span class="icons c3"><i class="icon-shield"></i></span> <div class="box-area">
        <h3>Fiber Net</h3> <p>Lorem ipsum dolor sitamet, consec tetur adipisicing elit. Dolores quae porro consequatur aliquam, incidunt eius magni provident</p></div>
        </div> </div>
        </div></div>
        </div> 
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-sm-6 text-center wow fadeInLeft animated" data-wow-animation-name="fadeInLeft">
            <img src="<?php echo get_bloginfo('template_url')?>/img/server.png" alt="">
          </div>
